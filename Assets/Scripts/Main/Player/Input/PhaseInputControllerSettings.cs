...
public abstract class PhaseInputControllerSettings
{
    public PhaseInputControllerEventManager eventManager { get; private set; } = new PhaseInputControllerEventManager();
